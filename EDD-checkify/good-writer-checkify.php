<?php
/*
Plugin Name: Easy Digital Download Checkify
...
Copyright 2015 Steve Bailey (email steveswdev@gmail.com) - Colomet (email colomet@hotmail.com)
...
class Good_Writer_Checkify {
   ...
   function front_end_scripts_method() {
	...
	// Check permissions
		...
		if ( (($post->post_type == 'post') || ($post->post_type == 'page')	/* For Easy Digital Download */|| ($post->post_type == 'download')	/* For Easy Digital Download */ ) && ($_POST['action'] != 'inline-save')) { 
